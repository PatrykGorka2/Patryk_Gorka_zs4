...
<body>
    ...
    <button class="button"><a href="Start.php">GORA</a></button>
    <div class="menu">
        <div class="menu-img">
        ...
        <ol>
            <li><a href="#">MENU</a>
                <ul>
                    ...
                    <li><a href="#" target="_blank">AKTUALNOŚCI</a>
                        <ul>
                        <li><a href="#" target="_blank">BLOG</a></li>
                        <li><a href="#" target="_blank">WPISY</a></li>
                        </ul>
                    </li>
                    <li><a href="#" target="_blank">ZAPISZ SIĘ</a></li>
                </ul>
            </li>
            </ol>
        </div>
       ...
       <div class="container">
        <div class="header-Start-lewo">
            <h2>witaj!</h2>
            <p>Strona pozwoli Ci lepiej <br> rozplanować twój plan!!</p>
            <h3>Zainteresowany?</h3>
            <button><a href="APLIKACJA.php" target="blank_">Przejdź do logowania</a></button>
        </div>
        <div class="header-Srart-img">
            <img src="images/grafika2.png" alt="">
        </div>
       </div>
    </header>
    <section class="www">
    ...
    <section class="koniec">
        <div class="koniec_">
            ...
            <div><button><a href="APLIKACJA.php" target="blank_">Przejdź do logowania</a></button></div>
        </div>
    </section>
