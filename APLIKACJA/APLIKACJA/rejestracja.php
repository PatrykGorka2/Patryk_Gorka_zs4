...
<body>
    ...
    <form action="rejestracja.php" method="post">
        ...
        <input type="password" name="haslo1"  class="logujj_input" placeholder="Haslo">
        ...
        <input type="password" name="haslo2"  class="logujj_input" placeholder="Powtórz hasło">
        <div>
    ...
    <button class="barara" name="pokazhaslo" onclick="myfunc()">Pokaz haslo</button>
    <script type='text/Javascript'>
            function myfunc() {
                const pass1 = document.querySelector('input[name="haslo1"]');
                const pass2 = document.querySelector('input[name="haslo2"]');
