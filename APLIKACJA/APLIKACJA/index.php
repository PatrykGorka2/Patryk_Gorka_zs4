...
<body>
    ...
    <div class="formik">
        <form action="logowanie.php" method="post">
            ...
            <input type="password" name="haslo" class="logujj_input" placeholder="haslo">
            <input type="submit" value="zaloguj sie" class="loguj_input" name="loguj">
            <input type="button" name='show' value="Show" onclick="myfunc()">
            
        </form>
        
        <script type='text/Javascript'>
            function myfunc() {
                const pass1 = document.querySelector('input[name="haslo"]');
